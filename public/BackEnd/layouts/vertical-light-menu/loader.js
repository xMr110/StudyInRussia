window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: 'BackEnd/src/assets/img/logo.svg',
                    lightLogo: 'BackEnd/src/assets/img/logo2.svg'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'BackEnd/src/assets/img/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
